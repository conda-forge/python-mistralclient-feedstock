...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/python-mistralclient-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-mistralclient-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add python-mistralclient
# for installing globally
pixi global install python-mistralclient
```
...
It is possible to list all of the versions of `python-mistralclient` available on your platform:
...
```
pixi search python-mistralclient --channel conda-forge
```
